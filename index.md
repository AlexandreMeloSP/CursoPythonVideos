    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        ...
        <span class="d-none d-lg-block">
          <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="site/img/profile.jpg" alt="">
        </span>
      </a>
    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          ...
          <div class="subheading mb-5">CEP 06414000 · Barueri-SP · (11) 94730-2333 ·
            <a href="mailto:alexandremelo.doc@outlook.com">alexandremelo.doc@outlook.com</a>
          </div>
